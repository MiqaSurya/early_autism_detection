...
-- Set search_path for update_modified_column
...
-- Set search_path for handle_email_confirmation
...
-- Set search_path for get_assessment_counts_by_risk
...
-- Set search_path for get_user_statistics
...
-- Set search_path for get_child_assessment_history
...
-- Set search_path for track_assessment_history
...
-- Set search_path for get_children_age_distribution
...
-- Set search_path for manually_verify_user_email
...
AS $$
BEGIN
  -- Only allow admins to manually verify emails
  IF NOT EXISTS (
...
-- Set search_path for get_recommendations_for_assessment
...
-- Set search_path for update_assessment_score
...
DECLARE
  ...
  v_parent_id UUID;
BEGIN
  -- Get parent ID for access control
...
-- Set search_path for calculate_assessment_score
