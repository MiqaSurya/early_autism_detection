-- =============================================================================
-- CENTER PORTAL DATABASE SETUP - RUN THIS IN SUPABASE SQL EDITOR
-- =============================================================================
...
-- Success message
SELECT 'Center Portal Database Setup Complete! You can now test registration and login.' as status;
